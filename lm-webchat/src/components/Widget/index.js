...
class Widget extends Component {
  ...
  dispatchMessage(message) {
    ...
    } else if (isAppointment(message)) {
      const element = message.attachment.payload.elements[0];
      this.props.dispatch(addAppointmentSnippet({
        title: element.title,
        content: element.buttons[0].title,
        link: element.buttons[0].url,
        target: '_blank'
      }));
    } else if (isDkwComplete(message)) {
      const element = message.attachment.payload.elements[0];
      this.props.dispatch(addDkwCompleteSnippet({
        title: element.title,
        content: element.buttons[0].title,
        link: element.buttons[0].url,
        target: '_blank'
      }));
    } else if (isAge(message)) {
      const element = message.attachment.payload.elements[0];
      console.log(element.title);
      this.props.dispatch(addAgeSnippet({
        title: element.title,
        content: element.buttons[0].title,
        link: element.buttons[0].url,
        target: '_blank'
    ...
    } else if (isConsultant(message)) {
      const element = message.attachment.payload.elements[0];
      console.log(element.title);
      this.props.dispatch(addConsultantSnippet({
        title: element.title,
        content: element.buttons[0].title,
        link: element.buttons[0].url,
        target: '_blank'
      }));
    } else if (isSymptom(message)) {
      const element = message.attachment.payload.elements[0];
      console.log(element.title);
      this.props.dispatch(addSymptomSnippet({
        title: element.title,
        content: element.buttons[0].title,
        link: element.buttons[0].url,
        target: '_blank'
      }));
    } else if (isMedication(message)) {
      const element = message.attachment.payload.elements[0];
      this.props.dispatch(addMedicationSnippet({
        title: element.title,
        content: element.buttons[0].title,
        link: element.buttons[0].url,
        target: '_blank'
      }));
    } else if (isSurgery(message)) {
      const element = message.attachment.payload.elements[0];
      this.props.dispatch(addSurgerySnippet({
        title: element.title,
        content: element.buttons[0].title,
        link: element.buttons[0].url,
        target: '_blank'
